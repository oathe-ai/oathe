...
![Claude Code hits its usage limit mid-fix; Codex opens in the same repo and Oathe resumes the task — progress, effect receipt, and verification target intact.](assets/oathe-hero.svg)
