...
Contributors' rules — the touchpoint principle for supported harnesses and the UX contract
(`docs/UX.md`) — are in `CLAUDE.md` outside the oathe fence; they bind Codex sessions equally.
